...
describe("Testing rocket store initial state", () => {
  ...
  test("The reducer should return the new state after update", () => {
    ...
    expect(rockets(previousState, fetchData(data))).toEqual({list: [
      {
        id: 1,
        name: "The Space x",
        type: "Rocket",
  ...
  test("The value of reserved property should be update to true", () => {
    const previousState = {list: [
      {
        id: 1,
        name: "The Space x",
    ...
    expect(rockets(previousState,  reserveRocket(1))).toEqual({list: [
      {
        id: 1,
        name: "The Space x",
        type: "Rocket",
